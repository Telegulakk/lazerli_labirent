...
#define LAZER_SIGNAL_Pin GPIO_PIN_5
#define LAZER_SIGNAL_GPIO_Port GPIOA
...
#define LDR1_Pin GPIO_PIN_11
#define LDR1_GPIO_Port GPIOA
#define LDR1_EXTI_IRQn EXTI15_10_IRQn
#define LDR2_Pin GPIO_PIN_12
#define LDR2_GPIO_Port GPIOA
#define LDR2_EXTI_IRQn EXTI15_10_IRQn
